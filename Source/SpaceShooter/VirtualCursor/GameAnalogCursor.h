...
public:
	/** Helper functions */
	SPACESHOOTER_API static void EnableAnalogCursor(class APlayerController* PC, TSharedPtr<SWidget> WidgetToFocus);
	SPACESHOOTER_API static void DisableAnalogCursor(class APlayerController* PC);
