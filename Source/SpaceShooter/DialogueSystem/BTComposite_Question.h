...
#include "DialogueSystem/DialogueSettings.h"
#include "DialogueSystem/BTContextNode_Interface.h"
...
*/
UCLASS()
class SPACESHOOTER_API UBTComposite_Question : public UBTCompositeNode, public IBTContextNode_Interface
{
