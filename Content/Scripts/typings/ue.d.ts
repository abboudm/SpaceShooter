...
declare type ESubstanceEngineType = string | symbol;
declare var ESubstanceEngineType = { SET_CPU:'SET_CPU',SET_GPU:'SET_GPU', };
...
declare class AutoPanner extends ContentWidget { 
	PaddingScale: Vector2D;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): AutoPanner;
	static Find(Outer: UObject, ResourceName: string): AutoPanner;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AutoPanner;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AutoPanner;
	GetNormalizedCursorPosition(): Vector2D;
	static C(Other: UObject): AutoPanner;
}

declare type EItemType = string | symbol;
declare var EItemType = { Equipable:'Equipable',Ammo:'Ammo',Loot:'Loot',Upgrade:'Upgrade',KeyItem:'KeyItem', };
declare type ELootType = string | symbol;
declare var ELootType = { Equipable:'Equipable',Craftable:'Craftable',Junk:'Junk', };
declare type EEquipableType = string | symbol;
declare var EEquipableType = { Weapon:'Weapon',Ammo:'Ammo',Throwable:'Throwable',Special:'Special', };
declare class HealthComponent extends ActorComponent { 
	MaxHealth: number;
	MaxShield: number;
	Alive: boolean;
	Health: number;
	...
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): HealthComponent;
	static Find(Outer: UObject, ResourceName: string): HealthComponent;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): HealthComponent;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HealthComponent;
	TakeDamage(damage: number): void;
	static C(Other: UObject): HealthComponent;
}

declare type EWeaponType = string | symbol;
declare var EWeaponType = { Rifle:'Rifle',Sniper:'Sniper',Pistol:'Pistol',Launcher:'Launcher',Melee:'Melee', };
declare type EAmmoType = string | symbol;
declare var EAmmoType = { Rifle:'Rifle',Sniper:'Sniper',Pistol:'Pistol',Launcher:'Launcher',Rocket:'Rocket',Grenade:'Grenade', };
declare class Item { 
	Name: string;
	Description: string;
	ItemType: EItemType;
	...
	Value: number;
	Weight: number;
	EquipableClass: StringClassReference;
	LootClass: StringClassReference;
	LootType: ELootType;
	isEquipped: boolean;
	EquipType: EEquipableType;
	...
	HitDamage: number;
	clone() : Item;
	static C(Other: UObject): Item;
}

declare class EquipmentComponent extends ActorComponent { 
	MaxPistolAmmo: number;
	MaxRifleAmmo: number;
	MaxSniperAmmo: number;
	MaxRocketAmmo: number;
	MaxGrenadeAmmo: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): EquipmentComponent;
	static Find(Outer: UObject, ResourceName: string): EquipmentComponent;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): EquipmentComponent;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): EquipmentComponent;
	UnEquipBackpack(): Item;
	UnEquip(): Item;
	SwitchCurrentItem(newItem: Equipable): Equipable;
	SwapCurrentBackpackItem(): void;
	SetCurrentItem(item: Equipable): void;
	SetBackpackItem(item: Equipable): void;
	RemoveCurrentItem(): Equipable;
	RemoveBackpackItem(): Equipable;
	GetCurrentItem(): Equipable;
	GetBackpackItem(): Equipable;
	EquipBackpack(equipItem: Item): Item;
	Equip(equipItem: Item): Item;
	DropItem(equipItem: Item): void;
	static C(Other: UObject): EquipmentComponent;
}

declare class InventoryComponent extends ActorComponent { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): InventoryComponent;
	static Find(Outer: UObject, ResourceName: string): InventoryComponent;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): InventoryComponent;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): InventoryComponent;
	GetNameList(): string[];
	GetInventory(): Item[];
	static C(Other: UObject): InventoryComponent;
}

declare class BaseTrainer extends Character { 
	...
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BaseTrainer;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BaseTrainer;
	static C(Other: UObject): BaseTrainer;
}

declare class Equipable extends Actor { 
	...
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): Equipable;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): Equipable;
	OnPrimaryTrigger(): void;
	OnSecondaryTrigger(): void;
	OnPrimaryTrigger(): void;
	GetPawnOwner(): BaseTrainer;
	GetMesh(): SkeletalMeshComponent;
	static C(Other: UObject): Equipable;
}

declare class Lootable extends Actor { 
	...
	ItemType: EItemType;
	LootType: ELootType;
	EquipClass: UnrealEngineClass;
	Quantity: number;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): Lootable;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): Lootable;
	static C(Other: UObject): Lootable;
}

declare type EClimbingMode = string | symbol;
declare var EClimbingMode = { CLIMB_None:'CLIMB_None',CLIMB_Climb:'CLIMB_Climb',CLIMB_LeftWallRun:'CLIMB_LeftWallRun',CLIMB_RightWallRun:'CLIMB_RightWallRun',CLIMB_Slide:'CLIMB_Slide',CLIMB_JumpOverBarrier:'CLIMB_JumpOverBarrier',CLIMB_UnderWallJump:'CLIMB_UnderWallJump',CLIMB_ZipLine:'CLIMB_ZipLine',CLIMB_InclinedSlide:'CLIMB_InclinedSlide',CLIMB_Thruster:'CLIMB_Thruster', };
declare class ClimbingPawnMovementComponent extends CharacterMovementComponent { 
	ClimbDeltaZ: number;
	AutoClimb: boolean;
	HoldJumpToClimb: boolean;
	ClimbVelocity: number;
	ClimbJumpVelocity: number;
	WallRunLimitAngle: number;
	WallOffset: number;
	WallRunFallGravityScale: number;
	WallRunInputVelocity: number;
	WallRunJumpZVelocity: number;
	MaxSprintSpeed: number;
	ThrusterForce: number;
	ThrusterCoolDown: number;
	WallRunJumpVelocity: number;
	ZipLineDeltaZ: number;
	ZipLineVelocity: number;
	ZipLineJumpVelocity: number;
	InclinedSlideAngle: number;
	InclinedSlideVelocityForward: number;
	InclinedSlideVelocityRight: number;
	InclinedJumpVelocity: number;
	RunVelocityCurve: RuntimeFloatCurve;
	CrouchedRunVelocityCurve: RuntimeFloatCurve;
	SprintVelocityCurve: RuntimeFloatCurve;
	SlideVelocityCurve: RuntimeFloatCurve;
	SlideThreshold: number;
	UnderWallJumpZVelocity: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ClimbingPawnMovementComponent;
	static Find(Outer: UObject, ResourceName: string): ClimbingPawnMovementComponent;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ClimbingPawnMovementComponent;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ClimbingPawnMovementComponent;
	Thruster(): void;
	SetClimbMode(_ClimbingMode: EClimbingMode): void;
	GetClimbingMode(): EClimbingMode;
	CanSetClimbMode(ClimbingMode: EClimbingMode): boolean;
	static C(Other: UObject): ClimbingPawnMovementComponent;
}

declare class Trainer extends BaseTrainer { 
	CameraSpringArm: SpringArmComponent;
	Camera: CameraComponent;
	LookXSensitivity: number;
	LookYSensitivity: number;
	ClimbingMovement: ClimbingPawnMovementComponent;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): Trainer;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): Trainer;
	ChangeView(FistPirson: boolean): void;
	static C(Other: UObject): Trainer;
}

declare type EContextExecutionMode = string | symbol;
declare var EContextExecutionMode = { CE_Sequence:'CE_Sequence',CE_Selector:'CE_Selector', };
declare class BTDialogueParameter { 
	StringKey: string;
	BlackboardKey: BlackboardKeySelector;
	clone() : BTDialogueParameter;
	static C(Other: UObject): BTDialogueParameter;
}

declare class BTComposite_Context extends BTCompositeNode { 
	ExecutionMode: EContextExecutionMode;
	DialogueParameters: BTDialogueParameter[];
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTComposite_Context;
	static Find(Outer: UObject, ResourceName: string): BTComposite_Context;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTComposite_Context;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTComposite_Context;
	static C(Other: UObject): BTComposite_Context;
}

declare class BTContextNode_Interface extends Interface { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTContextNode_Interface;
	static Find(Outer: UObject, ResourceName: string): BTContextNode_Interface;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTContextNode_Interface;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTContextNode_Interface;
	static C(Other: UObject): BTContextNode_Interface;
}

declare class BTComposite_Question extends BTCompositeNode { 
	QuestionThumbnail: string;
	bVisible: boolean;
	bHideAfterSelect: boolean;
	DialogueSettings: UnrealEngineClass;
	SettingName: string;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTComposite_Question;
	static Find(Outer: UObject, ResourceName: string): BTComposite_Question;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTComposite_Question;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTComposite_Question;
	static C(Other: UObject): BTComposite_Question;
}

declare class BTComposite_QuestionGroup extends BTCompositeNode { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTComposite_QuestionGroup;
	static Find(Outer: UObject, ResourceName: string): BTComposite_QuestionGroup;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTComposite_QuestionGroup;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTComposite_QuestionGroup;
	static C(Other: UObject): BTComposite_QuestionGroup;
}

declare class Quest_Task { 
	Title: string;
	TotalProgressNeeded: number;
	Progress: number;
	clone() : Quest_Task;
	static C(Other: UObject): Quest_Task;
}

declare class QuestBook extends UObject { 
	LastID: number;
	Quests: Quest[];
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): QuestBook;
	static Find(Outer: UObject, ResourceName: string): QuestBook;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): QuestBook;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): QuestBook;
	GetQuest(ID: number): Quest;
	static C(Other: UObject): QuestBook;
}
...
declare class Quest { 
	...
	QuestBook: QuestBook;
	clone() : Quest;
	static C(Other: UObject): Quest;
	UpdateTaskProgress(TaskIndex?: number): {Quest: Quest};
	static UpdateTaskProgress(Quest?: Quest,TaskIndex?: number): {Quest: Quest};
}

declare type EWidggetInputMode = string | symbol;
declare var EWidggetInputMode = { UIOnly:'UIOnly',GameAndUI:'GameAndUI', };
declare class BTDialogueCameraOptions { 
	bUseCamera: boolean;
	CameraToView: BlackboardKeySelector;
	PlayerCamera: BlackboardKeySelector;
	clone() : BTDialogueCameraOptions;
	static C(Other: UObject): BTDialogueCameraOptions;
}

declare class BTDialogueCinematicOptions { 
	bPlayMatinee: boolean;
	bLoop: boolean;
	Matinee: string;
	clone() : BTDialogueCinematicOptions;
	static C(Other: UObject): BTDialogueCinematicOptions;
}

declare class DialogueButton extends Button { 
	click: UnrealEngineMulticastDelegate<() => void>;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): DialogueButton;
	static Find(Outer: UObject, ResourceName: string): DialogueButton;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): DialogueButton;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DialogueButton;
	OnClick(): void;
	static C(Other: UObject): DialogueButton;
}

declare class BTTask_WaitAnswer extends BTTaskNode { 
	DialogueWidget: BlackboardKeySelector;
	InputMode: EWidggetInputMode;
	Timer: number;
	DialogueQuestionsSlotName: string;
	bUseGamepad: boolean;
	DialogueCameraOptions: BTDialogueCameraOptions;
	DialogueCinematicOptions: BTDialogueCinematicOptions;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTTask_WaitAnswer;
	static Find(Outer: UObject, ResourceName: string): BTTask_WaitAnswer;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTTask_WaitAnswer;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTTask_WaitAnswer;
	SetAnswer(DialogueButton: DialogueButton): void;
	HasTimer(): boolean;
	GetTimer(): number;
	static C(Other: UObject): BTTask_WaitAnswer;
}

declare class DialogueEventListener extends Widget { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): DialogueEventListener;
	static Find(Outer: UObject, ResourceName: string): DialogueEventListener;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): DialogueEventListener;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): DialogueEventListener;
	GetCurrentBrunch(): BTTask_WaitAnswer;
	static C(Other: UObject): DialogueEventListener;
	SkipCurrentPhrase(): void;
	static SkipCurrentPhrase(EventListener: DialogueEventListener): void;
}

declare class BTDialogueFunctionLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTDialogueFunctionLibrary;
	static Find(Outer: UObject, ResourceName: string): BTDialogueFunctionLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTDialogueFunctionLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTDialogueFunctionLibrary;
	static UpdateTaskProgress(Quest?: Quest,TaskIndex?: number): {Quest: Quest};
	static SkipCurrentPhrase(EventListener: DialogueEventListener): void;
	static SetQuestionVisibility(NodeOwner: BTNode,QuestionNodeName: string,NewVisibility: boolean): void;
	static HasQuest(Quests: Quest[],Quest: Quest): boolean;
	static GenerateSettings(DialogueSettings: UnrealEngineClass,PlayerController: PlayerController): DialogueSettings;
	static DeleteQuest(Quests?: Quest[],Quest?: Quest): {Quests: Quest[]};
	static AddQuest(Quests?: Quest[],Quest?: Quest): {Quests: Quest[]};
	static C(Other: UObject): BTDialogueFunctionLibrary;
}

declare type ECloseDialogueCursorOptions = string | symbol;
declare var ECloseDialogueCursorOptions = { Hide:'Hide',Show:'Show', };
declare class BTTask_CloseDialogue extends BTTaskNode { 
	DialogueWidget: BlackboardKeySelector;
	MouseOptions: ECloseDialogueCursorOptions;
	PlayerCamera: BlackboardKeySelector;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTTask_CloseDialogue;
	static Find(Outer: UObject, ResourceName: string): BTTask_CloseDialogue;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTTask_CloseDialogue;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTTask_CloseDialogue;
	static C(Other: UObject): BTTask_CloseDialogue;
}

declare class BTDialogueNameOptions { 
	bShowName: boolean;
	Name: string;
	DialogueSpeakerNameSlotName: string;
	clone() : BTDialogueNameOptions;
	static C(Other: UObject): BTDialogueNameOptions;
}

declare class BTDialogueImageOptions { 
	bShowImage: boolean;
	UImage: Texture2D;
	DialogueSpeakerImageSlotName: string;
	clone() : BTDialogueImageOptions;
	static C(Other: UObject): BTDialogueImageOptions;
}

declare class BTDialogueTextPhrase { 
	Phrase: string;
	SoundToPlay: SoundCue;
	ShowingTime: number;
	clone() : BTDialogueTextPhrase;
	static C(Other: UObject): BTDialogueTextPhrase;
}

declare type ETextEffect = string | symbol;
declare var ETextEffect = { NoEffect:'NoEffect',Typewriter:'Typewriter', };
declare class BTDialogueTextOptions { 
	bShowTextPhrases: boolean;
	bHideLastPhrase: boolean;
	GeneralShowingTime: number;
	UseGeneralTime: boolean;
	bShowRandomPhrase: boolean;
	DialoguePhraseSlotName: string;
	DialogueQuestionsSlotName: string;
	Phrases: BTDialogueTextPhrase[];
	TextEffect: ETextEffect;
	Delay: number;
	clone() : BTDialogueTextOptions;
	static C(Other: UObject): BTDialogueTextOptions;
}

declare class BTDialogueSoundOptions { 
	bPlaySound: boolean;
	bStopInEnd: boolean;
	SoundToPlay: SoundCue;
	clone() : BTDialogueSoundOptions;
	static C(Other: UObject): BTDialogueSoundOptions;
}

declare class BTAnimationBlendOptions { 
	SlotNodeName: string;
	BlendInTime: number;
	BlendOutTime: number;
	InPlayRate: number;
	clone() : BTAnimationBlendOptions;
	static C(Other: UObject): BTAnimationBlendOptions;
}

declare class BTDialogueCharacterAnimationOptions { 
	bPlayAnimation: boolean;
	bLoop: boolean;
	bWaitEndOfAnimation: boolean;
	Mesh: BlackboardKeySelector;
	Animation: AnimSequenceBase;
	AnimationBlendOptions: BTAnimationBlendOptions;
	clone() : BTDialogueCharacterAnimationOptions;
	static C(Other: UObject): BTDialogueCharacterAnimationOptions;
}

declare class BTTask_ShowPhrases extends BTTaskNode { 
	DialogueWidget: BlackboardKeySelector;
	InputMode: EWidggetInputMode;
	DialogueNameOptions: BTDialogueNameOptions;
	DialogueImageOptions: BTDialogueImageOptions;
	DialogueTextOptions: BTDialogueTextOptions;
	DialogueSoundOptions: BTDialogueSoundOptions;
	DialogueCameraOptions: BTDialogueCameraOptions;
	DialogueCinematicOptions: BTDialogueCinematicOptions;
	DialogueCharacterAnimationOptions: BTDialogueCharacterAnimationOptions;
	bShowPropertyDetails: boolean;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): BTTask_ShowPhrases;
	static Find(Outer: UObject, ResourceName: string): BTTask_ShowPhrases;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): BTTask_ShowPhrases;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): BTTask_ShowPhrases;
	static C(Other: UObject): BTTask_ShowPhrases;
}

declare class CanvasIcon { 
	Texture: Texture;
	U: number;
	V: number;
	UL: number;
	VL: number;
	clone() : CanvasIcon;
	static C(Other: UObject): CanvasIcon;
}

declare class Weapon extends Equipable { 
	WeaponType: EWeaponType;
	AmmoType: EAmmoType;
	bFullAuto: boolean;
	bBurst: boolean;
	...
	BurstDelay: number;
	ShotsPerMinute: number;
	Crosshair: CanvasIcon;
	bBottomlessClip: boolean;
	MuzzleSocket: string;
	FireSound: SoundCue;
	EquipSound: SoundCue;
	MuzzleFlash: ParticleSystem;
	EquipAnim: AnimMontage;
	FireAnim: AnimMontage;
	MuzzlePSC: ParticleSystemComponent;
	OutOfAmmoSound: SoundCue;
	NoAnimReloadDuration: number;
	NoEquipAnimDuration: number;
	MaxAmmoPerClip: number;
	ReloadSound: SoundCue;
	ReloadAnim: AnimMontage;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): Weapon;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): Weapon;
	ServerStopFire(): void;
	ServerStartReload(): void;
	ServerStartFire(): void;
	ServerHandleFiring(): void;
	GetCurrentAmmo(): number;
	static C(Other: UObject): Weapon;
}

declare class ImpactEffect extends Actor { 
	MetalFX: ParticleSystem;
	WoodFX: ParticleSystem;
	PlayerFX: ParticleSystem;
	MetalSound: SoundCue;
	WoodSound: SoundCue;
	PlayerSound: SoundCue;
	DecalMaterial: Material;
	DecalSize: number;
	DecalLifeSpan: number;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ImpactEffect;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ImpactEffect;
	static C(Other: UObject): ImpactEffect;
}

declare class HDamageType extends DamageType { 
	bCanDieFrom: boolean;
	HeadDmgModifier: number;
	LimbDmgModifier: number;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): HDamageType;
	static Find(Outer: UObject, ResourceName: string): HDamageType;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): HDamageType;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): HDamageType;
	static C(Other: UObject): HDamageType;
}

declare class InstantHitWeapon extends Weapon { 
	ImpactTemplate: UnrealEngineClass;
	TrailSourceParam: string;
	TrailTargetParam: string;
	TrailFX: ParticleSystem;
	TracerFX: ParticleSystem;
	MinimumProjectileSpawnDistance: number;
	TracerRoundInterval: number;
	WeaponSpread: number;
	ShotTraces: number;
	HitDamage: number;
	DamageType: UnrealEngineClass;
	WeaponRange: number;
	AllowedViewDotHitDir: number;
	ClientSideHitLeeway: number;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): InstantHitWeapon;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): InstantHitWeapon;
	ServerNotifyMiss(ShootDir: Vector_NetQuantizeNormal): void;
	ServerNotifyHit(Impact: HitResult,ShootDir: Vector_NetQuantizeNormal): void;
	OnRep_HitLocation(): void;
	static C(Other: UObject): InstantHitWeapon;
}
...
declare class Projectile extends Actor { 
	...
	bBounce: boolean;
	BounceLimit: number;
	HitImpulseStrength: number;
	ExplosionFX: ParticleSystem;
	ExplosionSound: SoundCue;
	ImpactTemplate: UnrealEngineClass;
	TrailFX: ParticleSystem;
	TrailScale: Vector;
	bExplosive: boolean;
	...
	OnHit(HitComp: PrimitiveComponent,OtherActor: Actor,OtherComp: PrimitiveComponent,NormalImpulse: Vector,Hit: HitResult): void;
	static C(Other: UObject): Projectile;
}

declare class ProjectileWeapon extends Weapon { 
	WeaponSpread: number;
	LauncherAngle: number;
	ShotTraces: number;
	Projectile: UnrealEngineClass;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ProjectileWeapon;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ProjectileWeapon;
	static C(Other: UObject): ProjectileWeapon;
}

declare class GameGlobals extends DeveloperSettings { 
	AnalogCursorAccelerationCurve: RuntimeFloatCurve;
	MaxAnalogCursorSpeed: number;
	MaxAnalogCursorSpeedWhenHovered: number;
	AnalogCursorDragCoefficient: number;
	AnalogCursorDragCoefficientWhenHovered: number;
	MinAnalogCursorSpeed: number;
	AnalogCursorDeadZone: number;
	AnalogCursorAccelerationMultiplier: number;
	AnalogCursorSize: number;
	bUseEngineAnalogCursor: boolean;
	bAnalogCursorNoAcceleration: boolean;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): GameGlobals;
	static Find(Outer: UObject, ResourceName: string): GameGlobals;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): GameGlobals;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): GameGlobals;
	static C(Other: UObject): GameGlobals;
}

declare class GlobalStyle extends SlateWidgetStyle { 
	MenuButtonStyle: ButtonStyle;
	TabButtonStyle: ButtonStyle;
	HeaderTextStyle: TextBlockStyle;
	TitleTextStyle: TextBlockStyle;
	ItemTextStyle: TextBlockStyle;
	HUDTextStyle: TextBlockStyle;
	clone() : GlobalStyle;
	static C(Other: UObject): GlobalStyle;
}

declare class GlobalMenuStyle extends SlateWidgetStyleContainerBase { 
	MenuStyle: GlobalStyle;
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): GlobalMenuStyle;
	static Find(Outer: UObject, ResourceName: string): GlobalMenuStyle;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): GlobalMenuStyle;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): GlobalMenuStyle;
	static C(Other: UObject): GlobalMenuStyle;
}

declare class AmmoLoot extends Lootable { 
	AmmoType: EAmmoType;
	AmmoAmmount: number;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): AmmoLoot;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): AmmoLoot;
	static C(Other: UObject): AmmoLoot;
}

declare class OverlapObject extends Actor { 
	ObjectType: EClimbingMode;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): OverlapObject;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): OverlapObject;
	static C(Other: UObject): OverlapObject;
}

declare class ZipLine extends OverlapObject { 
	StartBase: StaticMeshComponent;
	EndBase: StaticMeshComponent;
	Spline: SplineComponent;
	Pivot: SceneComponent;
	EndBox: BoxComponent;
	RopeMesh: StaticMesh;
	SplineHeight: number;
	...
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ZipLine;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ZipLine;
	static C(Other: UObject): ZipLine;
}

declare class PlayerCharacterController extends PlayerController { 
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): PlayerCharacterController;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PlayerCharacterController;
	static C(Other: UObject): PlayerCharacterController;
}

declare class SpaceHUD extends HUD { 
	Crosshair: CanvasIcon;
	HUDMainTexture: Texture2D;
	NormalFont: Font;
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): SpaceHUD;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SpaceHUD;
	static C(Other: UObject): SpaceHUD;
}

declare class SpaceShooterGameMode extends GameMode { 
	constructor(InWorld: World, Location?: Vector, Rotation?: Rotator);
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): SpaceShooterGameMode;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SpaceShooterGameMode;
	static C(Other: UObject): SpaceShooterGameMode;
}

declare class VirtualCursorFunctionLibrary extends BlueprintFunctionLibrary { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): VirtualCursorFunctionLibrary;
	static Find(Outer: UObject, ResourceName: string): VirtualCursorFunctionLibrary;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): VirtualCursorFunctionLibrary;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): VirtualCursorFunctionLibrary;
	static IsCursorOverInteractableWidget(): boolean;
	static EnableVirtualCursor(PC: PlayerController): void;
	static DisableVirtualCursor(PC: PlayerController): void;
	static C(Other: UObject): VirtualCursorFunctionLibrary;
}
...
declare class TRASHCLASS_PlayerCharacterABP_2 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PlayerCharacterABP_2;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PlayerCharacterABP_2;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PlayerCharacterABP_2;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PlayerCharacterABP_2;
	static C(Other: UObject): TRASHCLASS_PlayerCharacterABP_2;
}

declare class TRASHCLASS_PlayerCharacterABP_3 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PlayerCharacterABP_3;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PlayerCharacterABP_3;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PlayerCharacterABP_3;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PlayerCharacterABP_3;
	static C(Other: UObject): TRASHCLASS_PlayerCharacterABP_3;
}

declare class TRASHCLASS_PlayerCharacterABP_4 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PlayerCharacterABP_4;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PlayerCharacterABP_4;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PlayerCharacterABP_4;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PlayerCharacterABP_4;
	static C(Other: UObject): TRASHCLASS_PlayerCharacterABP_4;
}

declare class TRASHCLASS_damagetype_5 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_damagetype_5;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_damagetype_5;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_damagetype_5;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_damagetype_5;
	static C(Other: UObject): TRASHCLASS_damagetype_5;
}

declare class TRASHCLASS_impacttest_6 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_impacttest_6;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_impacttest_6;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_impacttest_6;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_impacttest_6;
	static C(Other: UObject): TRASHCLASS_impacttest_6;
}

declare class TRASHCLASS_impacttest_8 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_impacttest_8;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_impacttest_8;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_impacttest_8;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_impacttest_8;
	static C(Other: UObject): TRASHCLASS_impacttest_8;
}

declare class TRASHCLASS_TestPistol_9 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_TestPistol_9;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_TestPistol_9;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_TestPistol_9;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_TestPistol_9;
	static C(Other: UObject): TRASHCLASS_TestPistol_9;
}

declare class TRASHCLASS_TestRifle_10 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_TestRifle_10;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_TestRifle_10;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_TestRifle_10;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_TestRifle_10;
	static C(Other: UObject): TRASHCLASS_TestRifle_10;
}

declare class ORPHANED_DATA_ONLY_TestRifle_C_11 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ORPHANED_DATA_ONLY_TestRifle_C_11;
	static Find(Outer: UObject, ResourceName: string): ORPHANED_DATA_ONLY_TestRifle_C_11;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ORPHANED_DATA_ONLY_TestRifle_C_11;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ORPHANED_DATA_ONLY_TestRifle_C_11;
	static C(Other: UObject): ORPHANED_DATA_ONLY_TestRifle_C_11;
}

declare class TRASHCLASS_PlayerCharacter_12 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PlayerCharacter_12;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PlayerCharacter_12;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PlayerCharacter_12;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PlayerCharacter_12;
	static C(Other: UObject): TRASHCLASS_PlayerCharacter_12;
}

declare class TRASHCLASS_PlayerCharacter_14 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PlayerCharacter_14;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PlayerCharacter_14;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PlayerCharacter_14;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PlayerCharacter_14;
	static C(Other: UObject): TRASHCLASS_PlayerCharacter_14;
}

declare class TRASHCLASS_PlayerCharacter_16 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_PlayerCharacter_16;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_PlayerCharacter_16;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_PlayerCharacter_16;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_PlayerCharacter_16;
	static C(Other: UObject): TRASHCLASS_PlayerCharacter_16;
}

declare class TRASHCLASS_LevelEditorAttract_17 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_LevelEditorAttract_17;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_LevelEditorAttract_17;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_LevelEditorAttract_17;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_LevelEditorAttract_17;
	static C(Other: UObject): TRASHCLASS_LevelEditorAttract_17;
}

declare class ORPHANED_DATA_ONLY_LevelEditorAttract_C_18 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): ORPHANED_DATA_ONLY_LevelEditorAttract_C_18;
	static Find(Outer: UObject, ResourceName: string): ORPHANED_DATA_ONLY_LevelEditorAttract_C_18;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): ORPHANED_DATA_ONLY_LevelEditorAttract_C_18;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): ORPHANED_DATA_ONLY_LevelEditorAttract_C_18;
	static C(Other: UObject): ORPHANED_DATA_ONLY_LevelEditorAttract_C_18;
}
